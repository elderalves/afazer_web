...
// Form Home
$(".select-fornec").on("change", function(evt){

  var labelSelect = $(this).parent().find('.label-select');



  if($(this).val()) {
    labelSelect.addClass('label-active');
  } else {
    labelSelect.removeClass('label-active');
  }
});



// Ajax for Cities and States
// $('#cod_estados').change(function(){
//     if( $(this).val() ) {
//         $('#cod_cidades').hide();
//         $('.carregando').show();
//         $.getJSON('core/cidades.ajax.php?search=',{cod_estados: $(this).val(), ajax: 'true'}, function(j){
